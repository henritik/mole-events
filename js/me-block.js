...
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  const ME_Meta_Plugin = _ref => {
    ...
    if (postMeta._me_date == '' || postMeta._me_time == '' || postMeta._me_location == '') {
      wp.data.dispatch('core/notices').createInfoNotice('Mole-heads up! Great work, you have a brand new event now, but some basic information is still missing! How about to fill some in the right panel?', {
        id: 'META_NOTICE',
        isDismissible: true
      });
    }
